...
const LAYOUTS_KEY = 'DTC_UI_LAYOUTS'
const LAYOUTS_STATE_KEY = 'DTC_UI_LAYOUTS_STATE'
const ACTIVE_MARKET_KEY = 'DTC_UI_ACTIVE_MARKET'
const ACTIVE_EXCHANGE_KEY = 'DTC_UI_ACTIVE_EXCHANGE'
